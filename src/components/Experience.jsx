    ...
    <div className="z-0 pt-40 w-full bg-[#192841] py-16 px-4 ">
      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center md:mr-[-.5%] md:pl-5 md:mt-[-10%]">
          ...
          <h2 className=" py-2 text-1xl font-bold text-[#16e4f3]"> Brainlox | Python Instructor | September 2022 - Present</h2>
          <p className="py-1 text-[#16e4f3]"> • Teach kids from ages 7-14 the fundamentals of Python</p>

          <h2 className=" py-2 text-1xl font-bold text-[#16e4f3]"> NASA Lunabotics | LSC - Robotics Software Engineer | January 2022 - Present </h2>
          ...
          <h2 className=" py-2 text-1xl font-bold text-[#16e4f3]"> Rice University MolSSI Workshop | Student | June 2022</h2>
